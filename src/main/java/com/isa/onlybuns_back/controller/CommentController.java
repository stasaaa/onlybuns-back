...
public class CommentController {
    ...
    @Autowired
    public CommentController(CommentService commentService, CommentRateLimitService rateLimitService, UserService userService, PostService postService, FollowingService followingServic) {
