...
public class CommentController {
    ...
    @Autowired
    public CommentController(CommentService commentService, CommentRateLimitService rateLimitService, UserService userService, PostService postService, FollowingService followingServic, CommentRateLimitService commentRateLimitService, RateLimiterService rateLimiterService) {
        this.commentService = commentService;
        this.rateLimitService = rateLimitService;
        this.userService = userService;
        this.postService = postService;
        this.followingService = followingServic;
